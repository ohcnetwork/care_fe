    ...
    if (
      ...
      navigate(`/facility/${facilityId}/patients/verify`, {
        query: {
          ...
          partial_id: patient.id.startsWith("offline-")
            ? `offline-${patient.id.slice(8, 13)}`
  ...
  const handleVerify = () => {
    ...
    navigate(`/facility/${facilityId}/patients/verify`, {
      query: {
        ...
        partial_id: selectedPatient.id.startsWith("offline-")
          ? `offline-${selectedPatient.id.slice(8, 13)}`
          : selectedPatient.id.slice(0, 5),
      },
    });
  };
                    ...
                    <>
                      ...
                      <div className="rounded-lg border border-gray-200">
                        <Table>
                          ...
                          <TableBody>
                            {partialOfflinePatients.map((patient, index) => (
                              <TableRow
                                key={patient.id}
                                className="cursor-pointer"
                                onClick={() =>
