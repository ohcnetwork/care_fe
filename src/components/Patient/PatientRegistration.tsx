...
const getRequiredIdentifierConfigs = (facility: FacilityRead | undefined) => {
  if (!facility) return [];
...
const getOptionalIdentifierConfigs = (facility: FacilityRead | undefined) => {
  if (!facility) return [];
  const configs = facility.patient_instance_identifier_configs;
  return configs.filter(({ config }) => {
    if (config.auto_maintained) {
...
const getAutogeneratedIdentifierConfigs = (
  facility: FacilityRead | undefined,
) => {
  if (!facility) return [];
  const configs = facility.patient_instance_identifier_configs;
  return configs.filter(({ config }) => {
