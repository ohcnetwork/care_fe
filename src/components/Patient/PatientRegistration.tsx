...
import { ArrowLeft, CheckIcon, InfoIcon, XIcon } from "lucide-react";
            ...
            >
              ...
              >
                <AccordionTrigger className="flex justify-between">
                  <div className="flex gap-3 items-center w-full">
                    <h5 className="text-lg font-semibold">
                      2: {t("additional_details")} ({t("optional")})
                    </h5>
                    {/* TODO: add progress bar */}
                  </div>
                </AccordionTrigger>
              ...
              >
                <AccordionTrigger className="flex justify-between">
                  <div className="flex gap-3 items-center w-full">
                    <h5 className="text-lg font-semibold">
                      3: {t("deceased_details")} ({t("only_if_applicable")})
                    </h5>
                  </div>
                </AccordionTrigger>
                <AccordionContent className="px-1 flex flex-col gap-6">
                  <DeceasedDetailsContent form={form} />
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </form>
      ...
      <div className="w-full border-t border-gray-200 py-6 mt-6">
        <div className="max-w-2xl mx-auto flex justify-end">
          <Button
            ...
            // TODO: disable button if basic info not filled
      ...
      <FormField
        ...
        render={({ field }) => (
          <FormItem>
            ...
            <FormControl>
              <Input placeholder={t("type_name")} {...field} />
            </FormControl>
            <FormMessage />
          </FormItem>
        )}
    ...
    <>
      ...
      {!form.watch("permanent_address_same_as_address") && (
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t("permanent_address")}</FormLabel>
              <FormControl>
...
const DeceasedDetailsContent = ({
  ...
  return (
    <>
      <div className="flex items-center gap-2 mb-4 text-gray-500 bg-gray-100 p-4 rounded-md">
        <div>
          <InfoIcon className="size-4" />
        </div>
        <p className="text-sm text-gray-500">{t("deceased_disclaimer")}</p>
      </div>
      ...
      <div className="flex gap-2">
        ...
        <Button
          variant="outline"
          size="icon"
          className={form.watch("deceased_datetime") ? "mb-0.5" : "hidden"}
          onClick={() => form.setValue("deceased_datetime", null)}
        >
...
const getFormSchema = (t: TFunction) => {
  ...
  return z
    .object({
      ...
      // Fields that would be required only if isQuick
      address: isQuick
