...
export const PatientRegistration = ({ patientId }: { patientId?: string }) => {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    const isUpdate = Boolean(patientId);
...
const getEditableIdentifiers = (
  ...
  return identifiers.filter((identifier) => {
    // For patient create, do not pass in empty string (BE needs to be updated)
    // For patient update, pass in empty string to clear the identifier value on BE side
    if (
      (!onUpdate && !identifier.value) ||
      (onUpdate && identifier.value == null)
    ) {
      return false;
    }
