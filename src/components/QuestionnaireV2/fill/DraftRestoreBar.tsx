...
export function DraftRestoreBar({
  ...
  return (
    <div className="mx-auto mb-4 flex w-full max-w-3xl flex-col gap-3 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-900 sm:flex-row sm:items-start">
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1 space-y-1">
          ...
          {draft.structuredSkipped && (
            <p className="text-amber-800">
              {t("fill_draft_structured_skipped")}
            </p>
          )}
