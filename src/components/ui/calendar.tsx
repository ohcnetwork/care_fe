...
function Calendar({
  ...
  const _weekdayClassName = cn(
    "w-8 text-sm font-normal text-secondary-900",
  ...
  const _outsideClassName = cn(
    "day-outside text-secondary-700 opacity-50 aria-selected:bg-accent/50 aria-selected:text-gray-900 aria-selected:opacity-30",
    props.outsideClassName,
  );
  const _disabledClassName = cn(
    "text-secondary-700 opacity-50",
