...
import { BadgeCheck, LogOut, RefreshCw, Settings } from "lucide-react";
        ...
        <DropdownMenu>
          ...
          >
            ...
            <DropdownMenuGroup>
              ...
              <DropdownMenuItem
                onClick={() => {
                  const appearanceUrl = selectedFacilityId
                    ? `/facility/${selectedFacilityId}/users/${user.username}/appearance`
                    : `/users/${user.username}/appearance`;
