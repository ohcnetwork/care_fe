...
>(({ className, ...props }, ref) => (
  ...
  <div className="flex items-center border-b px-2" cmdk-input-wrapper="">
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        "flex h-10 w-full focus:border-none rounded-md bg-transparent py-3 text-sm outline-hidden placeholder:text-gray-500 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-gray-400",
        className,
      )}
      {...props}
    />
