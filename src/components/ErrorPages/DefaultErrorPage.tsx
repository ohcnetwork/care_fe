...
export default function ErrorPage({
  ...
  // Mouse tracking for blur mask effect (desktop only)
  useEffect(() => {
      ...
      <div className="max-w-lg mx-auto text-center px-4">
        ...
        <div className="mt-6">
          <Button
            ...
            className="rounded-md bg-emerald-700 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-emerald-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-emerald-800"
          >
            {t("return_to_care")}
          </Button>
        </div>
