...
export const FACILITY_TYPES = {
    "EDUCATIONAL": { "id": 1, "text": "Educational Inst" },
    "HOSPITAL": { "id": 2, "text": "Hospital" },
    "OTHER": { "id": 3, "text": "Other" },
    "HOSTEL": { "id": 4, "text": "Hostel" },
    "HOTEL": { "id": 5, "text": "Hotel" },
    "LODGE": { "id": 6, "text": "Lodge" },
};
...
export const MEDICAL_HISTORY_CHOICES = [
    { "id": 1, "text": "NO" },
    { "id": 2, "text": "Diabetes" },
