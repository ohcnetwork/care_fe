...
export function SpecimenForm({
  ...
  const [draftSpecimen, setDraftSpecimen] = useState<SpecimenRead | null>(null);
  ...
  // Create draft specimen on mount
  useEffect(() => {
    if (!currentUserId || isCreatingDraft || draftSpecimen) return;

    setIsCreatingDraft(true);
    const draftPayload: SpecimenFromDefinitionCreate = {
      specimen_definition: specimenDefinition.id,
      specimen: {
    ...
    createDraftSpecimen(draftPayload);
