...
import { InvoicePrintBody } from "@/pages/Facility/billing/invoice/components/InvoicePrintBody";
import { InvoiceTitle } from "@/pages/Facility/billing/invoice/components/InvoiceTitle";
    ...
    >
      ...
      >
        <div className="max-w-5xl mx-auto">
          ...
          <InvoiceBillTo
            patient={invoices[0].account.patient}
