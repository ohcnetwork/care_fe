...
} from "@/pages/Facility/billing/invoice/components/utils";
...
interface PrintableInvoiceBillToProps {
  patient: InvoiceRead["account"]["patient"];
  verifiedPatient?: PatientRead;
  className?: string;
  qrClassName?: string;
}

export function PrintableInvoiceBillTo({
  patient,
  verifiedPatient,
  className,
  qrClassName,
}: PrintableInvoiceBillToProps) {
...
interface PrintableInvoiceProps {
  ...
  /** Optional bill-to header rendered at the top of the invoice body. */
  billTo?: ReactNode;
}
