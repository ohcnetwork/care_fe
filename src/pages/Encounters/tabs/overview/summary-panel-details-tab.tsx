...
import { Plus, Signal, SquarePen } from "lucide-react";
...
import { Questionnaires } from "./summary-panel-details-tab/questionnaires";
            ...
            <div>
              ...
              <div>
                <Badge variant={ENCOUNTER_STATUS_COLORS[encounter.status]}>
                  {React.createElement(
                    ENCOUNTER_STATUS_ICONS[encounter.status],
                    {
                      className: "size-4",
                    },
                  )}
