    ...
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-col-reverse xl:flex-row gap-4">
        ...
        <div className="flex-1 space-y-4" data-cy="encounter-overview">
          ...
          {/* Allergies Section */}
          <div>
            <AllergyList patientId={patient.id} readOnly={!canEdit} />
          </div>

          {/* Symptoms Section */}
          <div>
            <SymptomsList patientId={patient.id} readOnly={!canEdit} />
          </div>

          {/* Diagnoses Section */}
          <div>
            <DiagnosisList patientId={patient.id} readOnly={!canEdit} />
          </div>
