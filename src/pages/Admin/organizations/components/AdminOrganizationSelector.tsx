  ...
  const renderOrganizationPopover = (className?: string) => {
    return (
      <Command className={className}>
        ...
        <div className="flex items-center px-3 py-2 border-b sticky top-[48px] bg-background z-10">
        ...
        <div className="flex items-center border-b px-3 sticky top-[96px] bg-background z-10">
          <CommandInput
