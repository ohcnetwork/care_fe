...
export const OCCUPATION_TYPES = [
  ...
  { id: 6, text: "Healthcare Practitioner", value: "HEALTHCARE_PRACTITIONER" },
  { id: 7, text: "Paramedics", value: "PARADEMICS" },
  {
    id: 8,
  ...
  { id: 13, text: "Chef or Head Cook", value: "CHEF" },
  {
    id: 14,
    text: "Protective Service Occupations",
    value: "PROTECTIVE_SERVICE",
  },
  { id: 15, text: "Hospitality Service Occupations", value: "HOSPITALITY" },
  { id: 16, text: "Custodial Occupations", value: "CUSTODIAL" },
  { id: 17, text: "Customer Service Occupations", value: "CUSTOMER_SERVICE" },
  { id: 18, text: "Sales Supervisor", value: "SALES_SUPERVISOR" },
  { id: 19, text: "Retail Sales Worker", value: "RETAIL_SALES_WORKER" },
  { id: 20, text: "Insurance Sales Agent", value: "INSURANCE_SALES_AGENT" },
  { id: 21, text: "Sales Representative", value: "SALES_REPRESENTATIVE" },
  { id: 22, text: "Real Estate Sales Agent", value: "REAL_ESTATE" },
  {
    id: 23,
    text: "Construction and Extraction Worker",
    value: "CONSTRUCTION_EXTRACTION",
  },
  { id: 24, text: "Farming, Fishing and Forestry", value: "AGRI_NATURAL" },
  { id: 25, text: "Production Occupations", value: "PRODUCTION_OCCUPATION" },
  { id: 26, text: "Aircraft Pilot or Flight Engineer", value: "PILOT_FLIGHT" },
  { id: 27, text: "Vehicle Driver", value: "VEHICLE_DRIVER" },
  { id: 28, text: "Military", value: "MILITARY" },
  { id: 29, text: "Homemaker", value: "HOMEMAKER" },
  { id: 30, text: "Other Occupations", value: "OTHERS" },
