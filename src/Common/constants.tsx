...
export const DOCTOR_SPECIALIZATION: Array<OptionsType> = [
  { id: 1, text: "General Medicine Doctors", desc: "bg-doctors-general" },
  ...
  { id: 7, text: "Cardiac Surgeon", desc: "bg-doctors-general" },
  { id: 8, text: "Cardiologist", desc: "bg-doctors-general" },
  { id: 9, text: "Dentist", desc: "bg-doctors-general" },
  { id: 10, text: "Dermatologist", desc: "bg-doctors-general" },
  { id: 11, text: "Diabetologist", desc: "bg-doctors-general" },
  { id: 12, text: "Emergency Medicine Physician", desc: "bg-doctors-general" },
  { id: 13, text: "Endocrinologist", desc: "bg-doctors-general" },
  { id: 14, text: "Family Physician", desc: "bg-doctors-general" },
  { id: 15, text: "Gastroenterologist", desc: "bg-doctors-general" },
  { id: 16, text: "General Surgeon", desc: "bg-doctors-general" },
  { id: 17, text: "Geriatrician", desc: "bg-doctors-general" },
  { id: 18, text: "Hematologist", desc: "bg-doctors-general" },
  { id: 29, text: "Immunologist", desc: "bg-doctors-general" },
  { id: 20, text: "Infectious Disease Specialist", desc: "bg-doctors-general" },
  { id: 21, text: "MBBS doctor", desc: "bg-doctors-general" },
  { id: 22, text: "Medical Officer", desc: "bg-doctors-general" },
  { id: 23, text: "Nephrologist", desc: "bg-doctors-general" },
  { id: 24, text: "Neuro Surgeon", desc: "bg-doctors-general" },
  { id: 25, text: "Neurologist", desc: "bg-doctors-general" },
  { id: 26, text: "Obstetrician and Gynecologist", desc: "bg-doctors-general" },
  { id: 27, text: "Oncologist", desc: "bg-doctors-general" },
  { id: 28, text: "Oncology Surgeon", desc: "bg-doctors-general" },
  { id: 29, text: "Ophthalmologist", desc: "bg-doctors-general" },
  {
    id: 30,
    text: "Oral and Maxillofacial Surgeon",
    desc: "bg-doctors-general",
  },
  { id: 31, text: "Orthopedic", desc: "bg-doctors-general" },
  { id: 32, text: "Orthopedic Surgeon", desc: "bg-doctors-general" },
  { id: 33, text: "Otolaryngologist (ENT)", desc: "bg-doctors-general" },
  { id: 34, text: "Palliative care Physician", desc: "bg-doctors-general" },
  { id: 35, text: "Pathologist", desc: "bg-doctors-general" },
  { id: 36, text: "Pediatric Surgeon", desc: "bg-doctors-general" },
  { id: 37, text: "Physician", desc: "bg-doctors-general" },
  { id: 38, text: "Plastic Surgeon", desc: "bg-doctors-general" },
  { id: 39, text: "Psychiatrist", desc: "bg-doctors-general" },
  { id: 40, text: "Pulmonologist", desc: "bg-doctors-general" },
  { id: 41, text: "Radio technician", desc: "bg-doctors-general" },
  { id: 42, text: "Radiologist", desc: "bg-doctors-general" },
  { id: 43, text: "Rheumatologist", desc: "bg-doctors-general" },
  { id: 44, text: "Sports Medicine Specialist", desc: "bg-doctors-general" },
  { id: 45, text: "Thoraco-Vascular Surgeon", desc: "bg-doctors-general" },
  {
    id: 46,
    text: "Transfusion Medicine Specialist",
    desc: "bg-doctors-general",
  },
  { id: 47, text: "Urologist", desc: "bg-doctors-general" },
  { id: 48, text: "Nurse", desc: "bg-doctors-general" },
  { id: 5, text: "Others", desc: "bg-doctors-general" },
];
