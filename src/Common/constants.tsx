...
export const DESIGNATION_HEALTH_CARE_WORKER: Array<OptionsType> = [
  { id: 1, text: "AMBULANCE DRIVER" },
  { id: 2, text: "ASHA" },
  { id: 3, text: "ATTENDER" },
  { id: 4, text: "CLEANING STAFF" },
  { id: 5, text: "CSSD STAFF" },
  { id: 6, text: "ANEASTHESIA TECHNICHIAN" },
  { id: 7, text: "DIALYSIS TECHNICIAN" },
  { id: 8, text: "DIETICIAN" },
  { id: 9, text: "DOCTOR" },
  { id: 10, text: "FIELD STAFF" },
  { id: 11, text: "LAB ASSISTANT" },
  { id: 12, text: "LAB TECHNICIAN" },
  { id: 13, text: "NURSING ASSISTANT" },
  { id: 14, text: "OFFICE STAFF" },
  { id: 15, text: "PALLIATIVE NURSE" },
  { id: 16, text: "PHARMACIST" },
  { id: 17, text: "PHYSICIAN ASSISTANT" },
  { id: 18, text: "PHYSIOTHERAPIST" },
  { id: 19, text: "PSYCHOLOGIST" },
  { id: 20, text: "RADIOLOGY TECHNICIAN" },
  { id: 21, text: "SECURITY STAFF" },
  { id: 22, text: "SONOLOGIST" },
  { id: 23, text: "STAFF NURSE" },
  { id: 24, text: "OTHERS" },
];
