...
> = {
  ...
  ONE_ZERO_TWO: {
    display: "1-0-2 (Once morning, twice night)",
    timing: {
      repeat: {
        frequency: 3,
        period: "1",
      ...
      code: {
        code: "1-0-2",
        display: "Once morning, twice night",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  TWO_ZERO_ONE: {
    display: "2-0-1 (Twice morning, once night)",
    timing: {
      repeat: {
        frequency: 3,
        period: "1",
      ...
      code: {
        code: "2-0-1",
        display: "Twice morning, once night",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  TWO_ZERO_TWO: {
    display: "2-0-2 (Twice morning, twice night)",
    timing: {
      repeat: {
        frequency: 4,
        period: "1",
      ...
      code: {
        code: "2-0-2",
        display: "Twice morning, twice night",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  HALF_ZERO_HALF: {
    display: "½-0-½ (Half morning, half night)",
    timing: {
      repeat: {
        frequency: 2,
        period: "1",
      ...
      code: {
        code: "½-0-½",
        display: "Half morning, half night",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  HALF_HALF_HALF: {
    display: "½-½-½ (Half three times a day)",
    timing: {
      repeat: {
        frequency: 3,
        period: "1",
  ...
  HALF_ZERO_ZERO: {
    ...
    timing: {
      ...
      code: {
        code: "½-0-0",
        display: "Half morning only",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  ZERO_ZERO_HALF: {
    display: "0-0-½ (Half night only)",
    timing: {
      repeat: {
        frequency: 1,
        period: "1",
      ...
      code: {
        code: "0-0-½",
        display: "Half night only",
        system: "http://terminology.hl7.org/CodeSystem/v3-GTSAbbreviation",
      },
    },
  },
  ZERO_HALF_ZERO: {
    display: "0-½-0 (Half noon only)",
    timing: {
      repeat: {
        frequency: 1,
        period: "1",
