  ...
  return (
    <SidebarProvider defaultOpen={sidebarOpen}>
      ...
      >
        ...
        <main
          id="pages"
          className="flex flex-col flex-1 max-w-full min-h-[calc(100svh-(--spacing(4)))] md:m-2 md:peer-data-[state=collapsed]:ml-0 border rounded-lg shadow-sm bg-gray-50 focus:outline-hidden"
        >
