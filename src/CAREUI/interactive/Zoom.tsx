...
export const ZoomControls = (props: { disabled?: boolean }) => {
  ...
  return (
    <div className="fixed bottom-8 right-8 flex flex-col items-center justify-center gap-1 rounded-full border border-secondary-400 bg-background p-0.5 shadow-lg md:flex-row-reverse md:gap-2">
      <Button
