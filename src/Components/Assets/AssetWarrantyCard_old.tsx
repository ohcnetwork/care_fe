...
function CardFrontView(asset: AssetData) {
  return (
    <div className="rounded-xl bg-gradient-to-br from-primary-500 to-primary-700 hover:scale-[1.01] hover:from-primary-500 hover:to-primary-600 text-white p-6 sm:w-96 sm:h-56 vs:w-80 vs:h-50 w-screen h-auto transition-all">
      ...
      <div className="flex flex-col px-2 items-center">
        ...
        {asset.support_phone ? (
          <a
            ...
            className="group flex gap-2 items-center justify-between text-white rounded hover:bg-black/20 py-2 px-3 transition-all"
          >
            <div className="text-gray-300  group-hover:text-gray-100 transition-all">
