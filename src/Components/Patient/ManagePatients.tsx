...
export const PatientManager = () => {
  ...
  if (data && data.length) {
    patientList = data.map((patient: any) => {
      ...
      const children = (
        <div
          className={`ring/0 hover:ring/100 group relative w-full h-full rounded-lg bg-white p-4 pl-5 text-black shadow transition-all duration-200 ease-in-out hover:pl-5 ${categoryClass}-ring overflow-hidden`}
        >
          <div
          ...
          <div className="flex flex-col items-start gap-4 md:flex-row">
                ...
                <div className="flex flex-row flex-wrap justify-start gap-2">
                  ...
                  {(!patient.last_consultation ||
                    ...
                    <span className="relative inline-flex">
                      ...
                      />
                      <span className="absolute -right-1 -top-1 flex w-3 h-3 items-center justify-center">
                        <span className="center absolute inline-flex w-4 h-4 animate-ping rounded-full bg-red-400"></span>
                        <span className="relative inline-flex w-3 h-3 rounded-full bg-red-600"></span>
                      </span>
                    </span>
                  )}
                  {!(
            ...
            {patient.last_consultation?.last_daily_round
              ...
              patient.last_consultation?.last_daily_round
                ...
                <div className="mb-auto flex w-8 h-8 shrink-0 items-center justify-center rounded-full border border-primary-600 bg-primary-100 text-xs font-semibold text-primary-600">
                  {
