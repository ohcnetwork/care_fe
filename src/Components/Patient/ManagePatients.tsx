    ...
    patientList = data.map((patient: any, idx: number) => {
      ...
      return (
        <Link
          key={`usr_${patient.id}`}
          href={patientUrl}
          className="w-full cursor-pointer p-4 rounded-lg bg-white shadow text-black border border-transparent hover:border-primary-500 hover:shadow-lg transition-all duration-200 ease-in-out"
        >
