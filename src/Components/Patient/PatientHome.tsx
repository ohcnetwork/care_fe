                    ...
                    {patientData.is_vaccinated &&
                      patientData.last_vaccinated_date && (
                        <div className="sm:col-span-1">
                          ...
                          <div className="mt-1 text-sm leading-5 text-gray-900">
                            {moment(patientData.last_vaccinated_date).format(
                              "LL"
                            )}
                          </div>
                        </div>
                              ...
                              <div className="sm:col-span-1">
                                ...
                                >
                                  ...
                                  <dd className="font-bold text-sm leading-5">
                                    {moment(shift.modified_date).format(
                                      "LLL"
                                    ) || "--"}
                                  </dd>
                                </dt>
                                    ...
                                    <div className="bg-white rounded shadow p-8 m-4 max-w-sm max-h-full text-center">
                                      ...
                                      <div className="mb-8">
                                        <p>
                                          ...
                                          transfer as complete? The Origin
                                          facility will no longer have access to
                                          this patient
                                        </p>
                                      </div>
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <div className="mt-1 text-sm leading-5 text-gray-900">
                      {patientData.estimated_contact_date
                        ? moment(patientData.estimated_contact_date).format(
                            "LL"
                          )
                        : "-"}
                    </div>
                  ...
                  <div className="sm:col-span-1">
                    ...
                    <div className="mt-1 text-sm leading-5 text-gray-900">
                      {(patientData.date_declared_positive &&
                        moment(patientData.date_declared_positive).format(
                          "LL"
                        )) ||
                        "-"}
                    </div>
