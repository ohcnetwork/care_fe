...
const SampleInfo = (props: any) => {
    ...
    if (!data) {
        return (<Box display='flex' flexDirection='column' key={key}>
            <Box display='flex' flexDirection='row' justifyContent='center' className={`${classes.mainHeader} 
${classes.borderRight} ${classes.borderLeft} ${classes.borderTop} ${classes.cellTBPadding}`}>
        ...
        ${classes.borderRight} ${classes.borderLeft} ${classes.borderBottom} ${classes.cellTBPadding}`}>
                ...
                <div className="w3-padding">Parameters not populated for this Sample</div>
            </div>
        </Box>);
    }
