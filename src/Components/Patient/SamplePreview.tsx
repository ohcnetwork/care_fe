      ...
      <>
        ...
        <Box display="block overflow-scroll h-screen" id="section-to-print">
          <Box component="div" display="flex" flexDirection="column">
            ...
            >
              <Box justifySelf="flex-start" style={{ padding: "8px" }}></Box>
              <Box justifySelf="flex-end">
                <Box style={{ padding: "8px" }}>
                  <img
                    src={coronasafeLogo}
                    className={classes.allLogo}
                    alt="Coronasafe"
                  />
                </Box>
              </Box>
            ...
            >
              <Box
                className={`${classes.cellTBPadding} text-black`}
              ...
              <div style={{ border: "solid 5px black" }}>
                ...
                >
                  ...
                  >
                    <Box
                      width="65%"
                      className={`${classes.borderRight} ${classes.cellTBPadding}`}
                    >
                      <Typography
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.name}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.age_years}{" "}
                        years{""}{" "}
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.age_months}{" "}
                        Months
                      </Typography>
                    </Box>
                  </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.local_body_name}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.gender}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.phone_number}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.district_name}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.state_name}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.specimen_details &&
                          sampleData.specimen_details.icmr_label}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                        sampleData.specimen_details &&
                        sampleData.specimen_details.is_repeated_sample !== null
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          ...
                          sampleData.medical_conditions.hospital_name}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.medical_conditions &&
                          sampleData.medical_conditions.hospital_pincode}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    {sampleData &&
                      ...
                      sampleData.specimen_details.icmr_category === "Cat 0" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                            Cat 0 - Repeat Sample of Positive Case / Follow Up
                            case
                          </Typography>
                        </Box>
                      )}
                    {sampleData &&
                      sampleData.specimen_details &&
                      sampleData.specimen_details.icmr_category === "Cat 1" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                            Cat 1 - Symptomatic International Traveller in last
                            14 days
                          </Typography>
                        </Box>
                      )}
                    {sampleData &&
                      sampleData.specimen_details &&
                      sampleData.specimen_details.icmr_category === "Cat 2" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                    ...
                    {sampleData &&
                      sampleData.specimen_details &&
                      sampleData.specimen_details.icmr_category === "Cat 3" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                    ...
                    {sampleData &&
                      sampleData.specimen_details &&
                      sampleData.specimen_details.icmr_category === "Cat 4" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                    ...
                    {sampleData &&
                      sampleData.specimen_details &&
                      sampleData.specimen_details.icmr_category ===
                        "Cat 5a" && (
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                            Cat 5a - Asymptomatic Direct and High Risk contact
                            of confirmed case - family Member
                          </Typography>
                        </Box>
                      )}
                    {sampleData &&
                      ...
                      sampleData.specimen_details.icmr_category ===
                        ...
                        <Box width="35%" className={`${classes.cellTBPadding}`}>
                          <Typography className={`${classes.cellText}`}>
                            Cat 5b - Asymptomatic Healthcare worker in contact
                            with confimred case without adequete protection
                          </Typography>
                        </Box>
                      )}
                  </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.address}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.pincode}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.email}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.date_of_birth}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.personal_details &&
                          sampleData.personal_details.passport_no}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.exposure_history &&
                          sampleData.exposure_history.travel_start_date}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.exposure_history &&
                          sampleData.exposure_history.travel_end_date}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.exposure_history &&
                          sampleData.exposure_history.contact_case_name}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.exposure_history &&
                          sampleData.exposure_history.quarantined_type}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    >
                      <Typography
                        className={`${classes.cellTitle} ${classes.marginRight10}`}
                      >
                        Health care worker working in a hospital involved in
                        managing patients
                      </Typography>
                    </Box>
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          ...
                          !!sampleData.medical_conditions.symptoms.length &&
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.medical_conditions &&
                          sampleData.medical_conditions.diagnosis}
                      </Typography>
                    </Box>
                  </Box>
                </Box>
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.medical_conditions &&
                          sampleData.medical_conditions.diff_diagnosis}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                        sampleData.medical_conditions &&
                        sampleData.medical_conditions.is_unusual_course !== null
                  ...
                  >
                    ...
                    <Box width="35%" className={`${classes.cellTBPadding}`}>
                      <Typography className={`${classes.cellText}`}>
                        {sampleData &&
                          sampleData.medical_conditions &&
                          sampleData.medical_conditions.doctor_name}
                      </Typography>
                    </Box>
                  </Box>
                  <Box
