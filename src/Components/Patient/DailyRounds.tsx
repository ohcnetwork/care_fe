      ...
      if (id) {
        ...
        if (obj) {
          ...
          Notification.Success({
            msg: `${capitalize(state.form.rounds_type)} Log Updates details updated successfully`,
          });
          if (["NORMAL", "TELEMEDICINE"].includes(state.form.rounds_type)) {
            navigate(
        ...
        if (obj) {
          dispatch({ type: "set_form", form: initForm });
          Notification.Success({
            msg: `${capitalize(state.form.rounds_type)} Log Updates details created successfully`,
          });
          if (["NORMAL", "TELEMEDICINE"].includes(state.form.rounds_type)) {
            if (data.clone_last) {
              navigate(
