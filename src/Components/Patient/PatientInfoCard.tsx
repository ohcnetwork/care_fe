...
export default function PatientInfoCard(props: {
  ...
  return (
    <>
      ...
      <section className="lg:justify-none flex w-full flex-col items-center justify-between space-y-3 p-2 md:p-4 lg:flex-row lg:space-x-2 lg:space-y-0">
        <div className="flex w-full flex-col justify-between gap-6 bg-white md:flex-row">
          ...
          <div className="flex flex-col items-center justify-center gap-2">
            ...
            <div>
              {patient.review_time &&
                ...
                Number(consultation?.review_interval) > 0 && (
                  <div
                    className={
                      "mb-2 inline-flex w-full items-center justify-center rounded-lg border border-gray-500 p-1 text-center text-xs font-semibold leading-4 " +
            ...
            <div className="flex flex-col items-center gap-2 xl:flex-row">
              <Link
                ...
                className="text-center font-semibold text-black hover:text-primary-600"
              >
                <i
            ...
            <div className="flex flex-col items-center gap-2 text-sm lg:mt-4 lg:w-full">
              <div className="flex flex-col items-center justify-center gap-2 text-sm text-gray-900 sm:text-sm lg:w-full lg:max-w-sm lg:flex-row lg:flex-wrap">
                {patient.action && patient.action != 10 && (
                  <div>
                    <div className="inline-flex  items-center justify-start rounded-lg border border-gray-500 bg-blue-700 p-1 px-3 text-xs font-semibold leading-4">
                ...
                <div>
                  <div className="inline-flex items-center justify-start rounded-lg border border-gray-500 bg-gray-200 p-1 px-3 text-xs font-semibold leading-4">
            ...
            <div className="flex flex-col items-center gap-2 text-sm lg:mt-4">
              {[
                [
                  "Respiratory Support",
          ...
          {consultation?.last_daily_round && (
            <div className="flex min-w-[5rem] items-center justify-center bg-white lg:ml-auto">
              <Mews dailyRound={consultation?.last_daily_round} />
            </div>
          )}
        </div>
        <div className="flex w-full flex-col gap-2 px-4 py-1 lg:ml-auto lg:w-fit">
          {!!consultation?.discharge_date && (
            <div className="flex flex-col items-center justify-center">
