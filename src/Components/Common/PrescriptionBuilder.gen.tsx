...
export type Props<T1> = {
  readonly prescriptions: Prescription__Prescription_t[];
  readonly setPrescriptions: (
    _1: (_1: T1) => Prescription__Prescription_t[]
  ) => void;
};
...
export const make: React.ComponentType<{
  readonly prescriptions: Prescription__Prescription_t[];
  readonly setPrescriptions: (
    _1: (_1: any) => Prescription__Prescription_t[]
  ) => void;
}> = PrescriptionBuilderBS.make;
