  ...
  const renderNavigationBtn = (label: any, disabled: any, classes: string) => {
    return (
      <button
        ...
        className={`${classes} -ml-px relative bg-white text-gray-600 hover:text-gray-800 hover:bg-gray-200 inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium focus:z-10 focus:outline-none focus:border-brand-primary-300 focus:shadow-outline-brand-primary transition ease-in-out duration-150  ${
    ...
    <div className="mx-auto mb-4">
      <div className="flex-1 flex justify-between sm:hidden">
        <a
          ...
          className="relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium rounded-md text-gray-700 bg-white hover:text-gray-500 focus:outline-none focus:shadow-outline-brand-primary focus:border-brand-primary-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150"
        >
          Previous
        </a>
        <a
          ...
          <nav className="relative z-0 inline-flex shadow-sm">
            ...
            {pageNumbers.map((pageNo) => (
              <button
                type="button"
                key={`page_${pageNo}`}
                className={`-ml-px relative inline-flex items-center px-4 py-2 border border-gray-300 text-sm leading-5 font-medium focus:z-10 focus:outline-none focus:border-brand-primary-300 focus:shadow-outline-brand-primary transition ease-in-out duration-150 ${
                  currentPage === pageNo
