    ...
    return (
        ...
        >
            <div className="flex items-center gap-4">
                <div className={`${archived ? "bg-secondary-100 text-secondary-500" : "bg-primary-500/10 text-primary-700"} w-14 aspect-square flex items-center justify-center rounded-full`}>
