...
export const HospitalList = () => {
  ...
  const [filterStates, _setFilterStates] = useState<FilterOptionType[]>([
    { name: "Gujarat", value: "Gujarat" },
  ]);
  const [filterDistricts, _setFilterDistricts] = useState<FilterOptionType[]>([
    { name: "Vadodara", value: "Vadodara" },
  ]);
  const [filterLocalBodies, _setFilterLocalBodies] = useState<
    FilterOptionType[]
