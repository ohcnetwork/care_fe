    ...
    <>
      <PrintPreview title="Treatment Summary" className="print-preview" >
        ...
        <div className="mb-5 mt-2 border border-secondary-800">
              ...
              <table className="w-full border-collapse border border-secondary-800">
                ...
                <tbody>
                  {investigations && investigations.results.length > 0 ? (
                    investigations.results.map((value: any, index: number) => {
                      return (
                        <tr key={index}>
                          <td className="border border-secondary-800 text-center">
                            {formatDate(
                              value["session_object"]["session_created_date"],
                            )}
                          </td>
                          <td className="border border-secondary-800 text-center">
          ...
          <div className="border-b-2 border-secondary-800 px-5 py-2 pb-4">
            <b>Treatment :</b>
              ...
              <table className="w-full border-collapse border border-secondary-800">
                <thead>
                  <tr>
                    ...
                    <th className="border border-secondary-800">Temperature</th>
                  </tr>
                </thead>
