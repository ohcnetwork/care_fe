...
import ConsultationNeurologocalMonitorTab from "./ConsultationNeurologicalMonitor";
...
export const ConsultationDetails = (props: any) => {
  ...
  // keys will come from  CONSULTATION_TABS
  const TABS = {
    ...
    NEUROLOGICAL_MONITORING: ConsultationNeurologocalMonitorTab,
