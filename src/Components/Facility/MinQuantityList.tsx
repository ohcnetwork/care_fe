  ...
  if (inventory && inventory.length) {
    inventoryList = inventory.map((inventoryItem: any) => (
      <tr key={inventoryItem.id} className="bg-white">
        ...
        <td className="px-5 py-5 border-b border-gray-200 text-sm ">
          <Button
            className="ml-2 bg-brand-primary-400 hover:bg-brand-primary-600"
            onClick={() =>
              navigate(
            ...
            <table className="min-w-full leading-normal shadow rounded-lg overflow-hidden">
              <thead>
                <tr>
                  ...
                  <th className="px-5 py-3 border-b-2 border-gray-200 bg-brand-primary-400 text-left text-xs font-semibold text-white uppercase tracking-wider"></th>
                </tr>
              </thead>
