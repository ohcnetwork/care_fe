...
function DistrictSelect(props: DistrictSelectProps) {
    ...
    const onDistrictSearch = useCallback(debounce(async (text: string) => {
        if (text) {
    ...
    return (<AutoCompleteAsyncField
        ...
        noOptionsText={hasSearchText ? "No district found, please try again" : "Start typing to begin search"}
