...
export default function ListView() {
  ...
  const fetchData = () => {
    setIsLoading(true);
    dispatch(listShiftRequests(formatFilter({ ...qParams, offset }), 'shift-list-call')).then((res: any) => {
      if (res && res.data) {
  ...
  useEffect(() => {
    ...
    [qParams.status, qParams.facility, qParams.orgin_facility, qParams.shifting_approving_facility, qParams.assigned_facility, qParams.emergency, qParams.is_up_shift, qParams.patient_name, qParams.created_date_before, qParams.created_date_after, qParams.modified_date_before, qParams.modified_date_after, qParams.patient_phone_number, qParams.ordering, qParams.is_kasp, offset]
  );
            ...
            <div>
              ...
              <dl className="grid grid-cols-1 col-gap-1 row-gap-2 sm:grid-cols-1">
                <div className="sm:col-span-1">
                  <dt title="Shifting status" className="text-sm leading-5 font-medium text-gray-500 flex items-center">
  ...
  return (
    <div className="flex flex-col h-screen px-2 pb-2">
      ...
      <div className="flex space-x-2 mt-2 ml-2">
        {badge("status", appliedFilters.status != "--" && appliedFilters.status)}
          ...
          <Loading />
            ...
            <div>
              <div className="flex justify-end mt-4 mr-2 -mb-4">
                <button className="text-xs hover:text-blue-800"
                  onClick={refreshList}>
