...
- In host dev mode, CARE auto-discovers valid local plugin apps from `apps/*/src/manifest.*` (any TS/JS extension) and loads them directly through the host Vite graph.
