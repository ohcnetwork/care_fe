...
- `playwright-tests.instructions.md` - E2E testing for healthcare workflows
...
- Playwright E2E Testing:
  ...
  - `npm run playwright:test:ui` -- opens Playwright UI (requires backend setup)
...
- Playwright browser installation may fail in restricted environments -- this is expected and documented
