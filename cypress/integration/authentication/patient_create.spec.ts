...
describe("Patient Creation", () => {
  it("Create", () => {
    ...
    cy.get("[data-testid=emergency-phone-number] input").type(emergency_phone_number, {"delay":100})
  ...
  it("Dashboard", () => {
    ...
    cy.get("[data-testid=patient-dashboard]").should("contain",emergency_phone_number)
  ...
  it("Edit", () => {
    ...
    cy.get("[data-testid=current-address] textarea").should("contain","Test Patient Address")
    // cy.get("[data-testid=permanent-address] input").should("be.checked")
    cy.get("[data-testid=ward-respective-lsgi] select").should("contain","MANAKKAPADY")
